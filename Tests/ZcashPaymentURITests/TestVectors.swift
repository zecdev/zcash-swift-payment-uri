...
//
//  Created by Pacu in 23-01-2026.
//
   
/// Contains test vectors extracted from https://github.com/zcash/zcash-test-vectors
enum TestVectors {
    /// Extracted from https://github.com/zcash/zcash-test-vectors/blob/master/test-vectors/json/unified_address.json
    /// commit `20d7cc6`
    static let unifiedAddresses = [
